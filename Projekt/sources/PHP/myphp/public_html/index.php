...
<html lang="en">
    <head>
        <!--TODO: Change that when Dungeon and Dragons Database is pressed, it directs to home- DONE-->
        <meta charset="utf-8" />
                    ...
                    <div class="col">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($gethighestLevelPartys as $index => $party) { ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td><?= $party['PARTY_NAME'] ?></td>
                                            <td><?= $party['AVERAGE_LEVEL'] ?></td>
                                    <?php } ?>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($getRichestPartys as $index => $party) { ?>
                                        <tr>
                                            <td><?= $index + 1 ?></td>
                                            <td><?= $party['PARTY_NAME'] ?></td>
                                            <td><?= $party['TOTAL_GOLD'] ?></td>
                                    <?php } ?>
                                </tbody>
                            </table>
                        </div>
